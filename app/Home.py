...
Act 1: three doors (Study / Analyze / Teach).
Act 2: Explore (collapsed inventory).
"""
...
# ---------------------------------------------------------------------------
# Act 1 — Start (three doors, geometric icons only)
# ---------------------------------------------------------------------------
section_header(t("home.start_header"))
st.caption(t("home.start_cap"))

d1, d2, d3 = st.columns(3)
with d1:
    link_action_card(
        "pages/5_Ruta_Aprendizaje.py",
        t("home.start_student_title"),
        t("home.start_student_body"),
        icon="⬡",
        accent="navy",
        cta=t("home.start_open"),
    )
with d2:
    link_action_card(
        "pages/4_Laboratorio.py",
        t("home.start_research_title"),
        t("home.start_research_body"),
        icon="◈",
        accent="teal",
        cta=t("home.start_open"),
    )
with d3:
    link_action_card(
        "pages/7_Docencia.py",
        t("home.start_teach_title"),
        t("home.start_teach_body"),
        icon="◎",
        accent="purple",
        cta=t("home.start_open"),
    )

# Session continuity: last lab run (if any)
...
# Compact domain context (emoji only here — domain identity, not mixed with marks above)
section_header(t("home.pick_domain_short"))
...
# Act 2 — Explore (collapsed inventory)
# ---------------------------------------------------------------------------
with st.expander(t("home.explore_header"), expanded=False):
    st.caption(t("home.explore_cap"))
    ...
    # Value props: geometric marks only (same system as Act 1 doors)
    c1, c2, c3 = st.columns(3)
    with c1:
        st.markdown(
            feature_card(
                t("home.card_ordinal_title"),
                t("home.card_ordinal_body"),
                icon="⬡",
                accent="navy",
            ),
    ...
    with c2:
        st.markdown(
            feature_card(
                t("home.card_recd_title"),
                t("home.card_recd_body"),
                icon="◈",
                accent="teal",
            ),
            unsafe_allow_html=True,
    ...
    with c3:
        st.markdown(
            feature_card(
                t("home.card_falsable_title"),
                t("home.card_falsable_body"),
                icon="◎",
                accent="purple",
            ),
            unsafe_allow_html=True,
    ...
    with a1:
        st.markdown(
            achieve_card(
                t("home.achieve_pipe_title"),
                t("home.achieve_pipe_body"),
    ...
    with a2:
        st.markdown(
            achieve_card(
                t("home.achieve_ev_title"),
                t("home.achieve_ev_body"),
                t("common.documented"),
            ),
            unsafe_allow_html=True,
        )
    with a3:
        st.markdown(
            achieve_card(
                t("home.achieve_curr_title"),
                t("home.achieve_curr_body"),
                t("common.available"),
            ),
            unsafe_allow_html=True,
        )
    with a4:
        st.markdown(
            achieve_card(
                t("home.achieve_tda_title"),
                t("home.achieve_tda_body"),
                t("common.operational"),
            ),
            unsafe_allow_html=True,
        )
    ...
    # Full-width page links as single hit areas (no decorative card + orphan link)
    n1, n2, n3, n4 = st.columns(4)
    with n1:
        page_link("pages/1_Fundamentos.py", label=t("home.nav_fund_title"), icon="📘")
        st.caption(t("home.nav_fund_body"))
    with n2:
        page_link("pages/2_Matematica.py", label=t("home.nav_math_title"), icon="📐")
        st.caption(t("home.nav_math_body"))
    with n3:
        page_link("pages/4_Laboratorio.py", label=t("home.nav_lab_title"), icon="🔬")
        st.caption(t("home.nav_lab_body"))
    with n4:
        page_link("pages/6_Evidencia.py", label=t("home.nav_ev_title"), icon="📑")
        st.caption(t("home.nav_ev_body"))
